  ...
  return (
    <div
      className={cn(
        ...
        isActive
          ? 'bg-linear-to-br from-white via-emerald-50/30 to-white border-emerald-300 shadow-lg shadow-emerald-100/50'
          : isCompleted
          ? 'bg-linear-to-br from-gray-50/30 to-white border-gray-200 opacity-90'
          : 'bg-linear-to-br from-white to-gray-50/30 border-gray-200 shadow-sm hover:shadow-md hover:border-emerald-200',
        className
      )}
    >
      {/* Active Indicator Strip */}
      {isActive && (
        <div className="absolute top-0 left-0 bottom-0 w-1.5 bg-linear-to-b from-emerald-400 via-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/50" />
      )}
